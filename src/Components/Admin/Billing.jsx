...
function Billing() {
  ...
  const [selectedDecision, setSelectedDecision] = useState(""); // State for selected decision ID
  ...
  return (
    <div>
      <div className="relative m-3 h-[420px] overflow-y-scroll text-white">
        {billings &&
          billings.map((item) => (
            <div
              key={item._id}
              ...
              <div className="flex gap-5 justify-center mt-3">
                <button
                  ...
                  className={`bg-white text-black p-1 px-3 rounded-full hover:bg-green-400 ${
                    reject ? "cursor-not-allowed opacity-50" : ""
                  }`}
                  disabled={reject}
                >
                  Approve
                ...
                <button
                  ...
                  className={`bg-white text-black p-1 px-4 rounded-full hover:bg-red-600 ${
                    reject ? "cursor-not-allowed opacity-50" : ""
                  }`}
                  disabled={reject}
                >
                  ...
                  <div className="bg-black text-white p-3 w-11/12 max-w-sm rounded-lg relative">
                    ...
                    <div className="w-full text-black">
                      ...
                      <div className="flex gap-4 justify-center my-4">
                        ...
                        <button
                          onClick={() => handleBillStatus(item._id, selectedDecision)} // Pass selectedDecision to the function
